...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/moderngl-window-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13631&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/moderngl-window-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `moderngl-window` can be installed with:

```
conda install moderngl-window
```

It is possible to list all of the versions of `moderngl-window` available on your platform with:
